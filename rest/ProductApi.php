    ...
    public function get_collection_params() {
        return array(
            'product_category' => array(
                'description'       => __( 'Product category slug', 'custom-product-badge-for-woocommerce' ),
                'type'              => 'string',
                'sanitize_callback' => 'sanitize_text_field',
                'validate_callback' => 'rest_validate_request_arg',
            ),
            'product_type' => array(
                'description'       => __( 'Product type', 'custom-product-badge-for-woocommerce' ),
                'type'              => 'string',
                'sanitize_callback' => 'sanitize_text_field',
                'validate_callback' => 'rest_validate_request_arg',
            ),
            'paged' => array(
                'description'       => __( 'Current page', 'custom-product-badge-for-woocommerce' ),
                'type'              => 'integer',
                'sanitize_callback' => 'absint',
                'validate_callback' => 'rest_validate_request_arg',
            ),
            'per_page' => array(
                'description'       => __( 'Number of products to display per page', 'custom-product-badge-for-woocommerce' ),
                'type'              => 'integer',
                'sanitize_callback' => 'absint',
                'validate_callback' => 'rest_validate_request_arg',
            ),
            'search' => array(
                'description'       => __( 'Search term', 'custom-product-badge-for-woocommerce' ),
                'type'              => 'string',
                'sanitize_callback' => 'sanitize_text_field',
                'validate_callback' => 'rest_validate_request_arg',
            ),
            'status' => array(
                'description'       => __( 'Product status', 'custom-product-badge-for-woocommerce' ),
                'type'              => 'string',
                'sanitize_callback' => 'sanitize_text_field',
                'validate_callback' => 'rest_validate_request_arg',
            ),
    ...
    public function get_item_schema() {
        return array(
            ...
            'properties' => array(
                ...
                'name' => array(
                    'description' => __( 'Product name.', 'custom-product-badge-for-woocommerce' ),
                    'type'        => 'string',
                    'context'     => array( 'view' ),
                    'readonly'    => true,
                ),
                'sku' => array(
                    'description' => __( 'Product SKU.', 'custom-product-badge-for-woocommerce' ),
                    'type'        => 'string',
                    'context'     => array( 'view' ),
                    'readonly'    => true,
                ),
                'regular_price' => array(
                    'description' => __( 'Product regular price.', 'custom-product-badge-for-woocommerce' ),
                    'type'        => 'string',
                    'context'     => array( 'view' ),
                    'readonly'    => true,
                ),
                'sale_price' => array(
                    'description' => __( 'Product sale price.', 'custom-product-badge-for-woocommerce' ),
                    'type'        => 'string',
                    'context'     => array( 'view' ),
                    'readonly'    => true,
                ),
                'stock_quantity' => array(
                    'description' => __( 'Product stock quantity.', 'custom-product-badge-for-woocommerce' ),
                    'type'        => 'integer',
                    'context'     => array( 'view' ),
                    'readonly'    => true,
                ),
                'stock_status' => array(
                    'description' => __( 'Product stock status.', 'custom-product-badge-for-woocommerce' ),
                    'type'        => 'string',
                    'context'     => array( 'view' ),
                    'readonly'    => true,
                ),
                'backorder' => array(
                    'description' => __( 'Product backorder status.', 'custom-product-badge-for-woocommerce' ),
                    'type'        => 'string',
                    'context'     => array( 'view' ),
                    'readonly'    => true,
                ),
                ...
                'wc_stock' => array(
                    'description' => __( 'Product stock management.', 'custom-product-badge-for-woocommerce' ),
                    'type'        => 'boolean',
                    'context'     => array( 'view' ),
                    'readonly'    => true,
                ),
